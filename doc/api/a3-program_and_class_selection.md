...
|  方法  |              uri               | 请求参数 |                  返回参数<br>除了status以外                  |             说明             |
| :----: | :----------------------------: | :------: | :----------------------------------------------------------: | :--------------------------: |
|  PUT   |        /program/course         |   cid    |                              -                               |       培养方案添加课程       |
| DELETE |        /program/course         |   cid    |                     cid<br>cname<br>uid                      |       培养方案删除课程       |
|  GET   |        /program/status         |    -     | **List of:**<br>courseId<br>courseName<br>credit(Float)<br>type<br>status |    查看培养方案中课程状态    |
|  GET   |   /program/status/in_program   |    -     |                             同上                             | 查看已选进培养方案的课程状态 |
|  GET   | /program/status/not_in_program |    -     |                             同上                             | 查看未选进培养方案的课程状态 |
...
+ 查看培养方案中课程的状态（哪些课程已选，哪些没选，……）
  ...
  + request: 无
  + response: `{"status",courses:[{"courseId", "courseName", "credit", "type", "status"}, {..}, ...]"}`
    + **credit**: Float
...
|  方法  |                     uri                     |    请求参数    |                   返回参数<br>不包括status                   |              说明              |
| :----: | :-----------------------------------------: | :------------: | :----------------------------------------------------------: | :----------------------------: |
...
|  POST  |              /classes/register              | classId(Long)  |                              -                               |              选课              |
| DELETE |                /classes/drop                | classId(Long)  |                              -                               |              退课              |
...
|  POST  |              /course/get/info               |      cid       | cid<br>name<br>credit(Float)<br>numLessonsEachWeek(Integer)<br>department<br>intro | 查看课程信息**（是A2组写的）** |
