...
|  POST  |   /user/modify/pwd    | uid:String(required)<br>oldPassword:String(required)<br>newPassword:String(required) |          status:String<br>uid:String<br>name:String          | 更改当前用户的密码，成功后返回当前用户的用户名和姓名 |
...
|  POST  |  /course/modify  | cid:String(required)<br>name:String(optional)<br>credit:Float(optional)<br>numLessonsEachWeek:Int(optional)<br>department:String(optinal)<br>intro:String(optional) | status:String<br>cid:String<br>name:String<br>credit:Float<br>numLessonsEachWeek:Int<br>department:String<br>intro:String | 修改指定课程的信息 |
|  GET   | /course/get/info |                     cid:String(required)                     | status:String<br>cid:String<br>name:String<br>credit:Float<br>numLessonsEachWeek:Int<br>department:String<br>intro:String | 获取指定课程的信息 |
|  POST  |  /course/query   | cid:String<br>name:String(optional)<br>department:String(optional) | status:String<br>cids:String[]<br>names:String[]<br>departments:String[] |    模糊查找课程    |
...
|  POST  |  /dept/department/modify  |                    name:String(required)                     |                 status:String<br>name:String                 |  修改指定院系的信息  |
...
|  GET   |   /dept/class/get/info    |                    name:String(required)                     | status:String<br>name:String<br>major:String<br>year:Int<br>unames:String[]<br>uids:String[] | 获取指定专业班的信息 |
