...
public class PrintClassroomResponse {
    ...
    public PrintClassroomResponse(String status, String building, Integer room,List<String> courseName, List<String> day,
    ...
    public List<String> getTeacherName(){ return teacherName; }
